#' The 'nomeRpredict' package.
#'
#' @description
#' This package is only for iptimization, testing and debugging of the ftp prediction functionality
...
#'
#' @useDynLib nomeRpredict, .registration = TRUE
#' @import methods
#' @import Rcpp
