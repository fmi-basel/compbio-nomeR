...
#' 
#' This function as an input protection statistics (see description for \code{protect_stat_table}) and infers parameters for beta-binomial distribution which fits the data.
#'
