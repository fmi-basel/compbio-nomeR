...
#'     observed counts for 00, 01, 10, and 11 at spacing "S". This table can be
#'      obtained using functions nomeR::count_joint_frequencies(...) or 
...
#'     algorithm.
#' @param ... Parameters for \code{\link[rstan]{sampling}} function. Please 
