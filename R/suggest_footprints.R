...
#' 
#'
#' @param S footprint lengths as returned by \code{\link{infer_footprints_stan_sampling}}, \code{\link{infer_footprints_stan_vb}} 
...
#' @param y mean or another measure of footprint abundance as returned by \code{\link{infer_footprints_stan_sampling}}, \code{\link{infer_footprints_stan_vb}} 
