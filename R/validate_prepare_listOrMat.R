...
validate_prepare_listOrMat <- function(data) {
    if (test_matrix(data, mode = "integerish",
        ...
        ## convert NAs to 2. For matrix we keep all positions, even with NAs 
        ## as starts and ends must match dimensions of input matrix
        ...
        ## input list; 2nd column is and index within the vector; 3rd column is protect
