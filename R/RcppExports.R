...
run_cpp_nomeR <- function(data, binding_models, bgprotectprob, bgprior, Ncpu, verbose) {
    .Call(`_nomeR_run_cpp_nomeR`, data, binding_models, bgprotectprob, bgprior, Ncpu, verbose)
}
