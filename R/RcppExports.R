...
run_cpp_nomeR <- function(fragIDs, fragPos, protectVec, binding_models, bgprotectprob, bgprior, report_prediction_in_flanks, Ncpu, verbose) {
    .Call(`_nomeRpredict_run_cpp_nomeR`, fragIDs, fragPos, protectVec, binding_models, bgprotectprob, bgprior, report_prediction_in_flanks, Ncpu, verbose)
}
