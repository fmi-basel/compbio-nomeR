...
class model_background_betabinom_model
  : public stan::model::model_base_crtp<model_background_betabinom_model> {
private:
        int n_table_entries;
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            for (int n = 1; n <= n_table_entries; ++n) {
                ...
                lp_accum__.add((get_base1(n_frequencies, n, "n_frequencies", 1) * beta_binomial_log(get_base1(n_protect_pos, n, "n_protect_pos", 1), get_base1(n_total_pos, n, "n_total_pos", 1), alpha_betabinom, beta_betabinom)));
            }
        } catch (const std::exception& e) {
            stan::lang::rethrow_located(e, current_statement_begin__, prog_reader__());
            // Next line prevents compiler griping about no return
...
typedef model_background_betabinom_model_namespace::model_background_betabinom_model stan_model;
#ifndef USING_R
