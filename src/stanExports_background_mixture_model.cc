...
#include "stanExports_background_mixture_model.h"

RCPP_MODULE(stan_fit4background_mixture_model_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("rstantools_model_background_mixture_model")
