...
RcppExport SEXP _nomeRpredict_run_cpp_nomeR(SEXP dataSEXP, SEXP fragnamesSEXP, SEXP binding_modelsSEXP, SEXP bgprotectprobSEXP, SEXP bgpriorSEXP, SEXP report_prediction_in_flanksSEXP, SEXP NcpuSEXP, SEXP verboseSEXP) {
BEGIN_RCPP
...
RcppExport SEXP _nomeRpredict_count_spacing_freq_cpp(SEXP dataSEXP, SEXP fragnamesSEXP, SEXP maxspacingSEXP, SEXP maxwmlenSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< const Rcpp::List& >::type data(dataSEXP);
...
RcppExport SEXP _nomeRpredict_calculate_theor_joint_prob_cpp(SEXP ftp_cover_priorsSEXP, SEXP bg_protect_probSEXP, SEXP footprint_protect_probSEXP, SEXP max_spacingSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
static const R_CallMethodDef CallEntries[] = {
    {"_nomeRpredict_run_cpp_nomeR", (DL_FUNC) &_nomeRpredict_run_cpp_nomeR, 8},
...
RcppExport void R_init_nomeRpredict(DllInfo *dll) {
