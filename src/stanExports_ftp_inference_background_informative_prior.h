...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_ftp_inference_background_informative_prior");
    reader.add_event(181, 179, "end", "model_ftp_inference_background_informative_prior");
    return reader;
}
...
class model_ftp_inference_background_informative_prior
  : public stan::model::model_base_crtp<model_ftp_inference_background_informative_prior> {
private:
        int n_ftp;
...
public:
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        try {
            ...
            context__.validate_dims("data initialization", "bg_protect_min", "double", context__.to_vec());
            bg_protect_min = double(0);
            vals_r__ = context__.vals_r("bg_protect_min");
            pos__ = 0;
            bg_protect_min = vals_r__[pos__++];
            current_statement_begin__ = 91;
            context__.validate_dims("data initialization", "bg_protect_max", "double", context__.to_vec());
            bg_protect_max = double(0);
            vals_r__ = context__.vals_r("bg_protect_max");
            pos__ = 0;
            bg_protect_max = vals_r__[pos__++];
            current_statement_begin__ = 92;
            context__.validate_dims("data initialization", "bg_protect_alpha", "double", context__.to_vec());
            bg_protect_alpha = double(0);
            vals_r__ = context__.vals_r("bg_protect_alpha");
            pos__ = 0;
            bg_protect_alpha = vals_r__[pos__++];
            check_greater_or_equal(function__, "bg_protect_alpha", bg_protect_alpha, 0);
            current_statement_begin__ = 93;
            context__.validate_dims("data initialization", "bg_protect_beta", "double", context__.to_vec());
            bg_protect_beta = double(0);
            vals_r__ = context__.vals_r("bg_protect_beta");
            pos__ = 0;
            bg_protect_beta = vals_r__[pos__++];
            check_greater_or_equal(function__, "bg_protect_beta", bg_protect_beta, 0);
    ...
    void transform_inits(const stan::io::var_context& context__,
        ...
        try {
            writer__.scalar_lub_unconstrain(bg_protect_min, bg_protect_max, bg_protect_prob);
        } catch (const std::exception& e) {
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            if (jacobian__)
                bg_protect_prob = in__.scalar_lub_constrain(bg_protect_min, bg_protect_max, lp__);
            else
                bg_protect_prob = in__.scalar_lub_constrain(bg_protect_min, bg_protect_max);
            current_statement_begin__ = 139;
            ...
            lp_accum__.add(beta_log<propto__>(bg_protect_prob, bg_protect_alpha, bg_protect_beta));
    ...
    void write_array(RNG& base_rng__,
        ...
        double bg_protect_prob = in__.scalar_lub_constrain(bg_protect_min, bg_protect_max);
    ...
    std::string model_name() const {
        return "model_ftp_inference_background_informative_prior";
    }
...
typedef model_ftp_inference_background_informative_prior_namespace::model_ftp_inference_background_informative_prior stan_model;
#ifndef USING_R
