...
static constexpr std::array<const char*, 25> locations_array__ =
  ...
  " (in 'ftp_inference_ftp_bg_fixed', line 36, column 8 to column 14)",
  " (in 'ftp_inference_ftp_bg_fixed', line 36, column 2 to column 46)",
  " (in 'ftp_inference_ftp_bg_fixed', line 38, column 2 to column 12)",
  " (in 'ftp_inference_ftp_bg_fixed', line 39, column 8 to column 13)",
  " (in 'ftp_inference_ftp_bg_fixed', line 39, column 2 to column 31)",
  " (in 'ftp_inference_ftp_bg_fixed', line 40, column 9 to column 14)",
  " (in 'ftp_inference_ftp_bg_fixed', line 40, column 2 to column 32)",
...
public:
  ...
  model_ftp_inference_ftp_bg_fixed(stan::io::var_context& context__,
    ...
    try {
      ...
      context__.validate_dims("data initialization", "ftp_protect_prob",
        "double", std::vector<size_t>{});
      ftp_protect_prob = std::numeric_limits<double>::quiet_NaN();
      current_statement__ = 16;
      ftp_protect_prob = context__.vals_r("ftp_protect_prob")[(1 - 1)];
      current_statement__ = 16;
      stan::math::check_greater_or_equal(function__, "ftp_protect_prob",
        ftp_protect_prob, 0);
      current_statement__ = 16;
  ...
  get_param_names(std::vector<std::string>& names__, const bool
    ...
    names__ = std::vector<std::string>{"ftp_abundances"};
  ...
  inline std::string get_constrained_sizedtypes() const {
    return std::string("[{\"name\":\"ftp_abundances\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(n_ftp) + "},\"block\":\"parameters\"}]");
  }
  inline std::string get_unconstrained_sizedtypes() const {
    return std::string("[{\"name\":\"ftp_abundances\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string((n_ftp -1)) + "},\"block\":\"parameters\"}]");
  }
