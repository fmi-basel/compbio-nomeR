...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_ftp_inference_background_footprint_fixed");
    reader.add_event(161, 159, "end", "model_ftp_inference_background_footprint_fixed");
    return reader;
}
...
class model_ftp_inference_background_footprint_fixed
  : public stan::model::model_base_crtp<model_ftp_inference_background_footprint_fixed> {
private:
        int n_ftp;
...
public:
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        try {
            ...
            context__.validate_dims("data initialization", "footprint_protect_prob", "double", context__.to_vec());
            footprint_protect_prob = double(0);
            vals_r__ = context__.vals_r("footprint_protect_prob");
            pos__ = 0;
            footprint_protect_prob = vals_r__[pos__++];
            check_greater_or_equal(function__, "footprint_protect_prob", footprint_protect_prob, 0);
            check_less_or_equal(function__, "footprint_protect_prob", footprint_protect_prob, 1);
    ...
    std::string model_name() const {
        return "model_ftp_inference_background_footprint_fixed";
    }
...
typedef model_ftp_inference_background_footprint_fixed_namespace::model_ftp_inference_background_footprint_fixed stan_model;
#ifndef USING_R
