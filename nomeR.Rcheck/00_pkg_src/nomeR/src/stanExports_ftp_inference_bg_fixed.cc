...
#include "stanExports_ftp_inference_bg_fixed.h"

RCPP_MODULE(stan_fit4ftp_inference_bg_fixed_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("rstantools_model_ftp_inference_bg_fixed")
