...
#'
#' WARNING: Although finding a posterior mode is fast, the returned point
#' estimates are often far from the posterior means because the distribution
#' is highly non-symmetric. Therefore, footprint spectral analysis using
#' \code{rstan::optimizing} is unreliable unless a very strong and symmetric
#' prior is used.
#'
